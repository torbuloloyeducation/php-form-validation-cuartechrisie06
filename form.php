<?php
$nameErr = $emailErr = $phoneErr = $websiteErr = $passwordErr = $confirmPasswordErr = $termsErr = $genderErr = "";
...
$formValid = $submitted && empty($nameErr) && empty($emailErr) && empty($phoneErr) && empty($websiteErr) && empty($passwordErr) && empty($confirmPasswordErr) && empty($termsErr) && empty($genderErr);
?>
...
<div class="form-container">
    ...
    <p class="required-note">Submission attempt: <?= $attemptCount ?></p>
    ...
    <form method="post" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>">
        ...
        <div class="field-row">
            ...
            <input type="text" id="phone" name="phone" placeholder="+1 555-123-4567" value="<?= $phone ?>">
        ...
        <div class="field-row">
            <label class="radio-item">
                <input type="checkbox" name="terms" <?= $termsAccepted ? "checked" : "" ?>>
